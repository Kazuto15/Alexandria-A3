...
public class TipoLivroDao {
    ...
    public void create(TipoLivro t){
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO tb_TipoLivros (tipo) VALUES (?)");
     ...
     public List<TipoLivro> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM tb_TipoLivros");
      ...
      public void update(TipoLivro t){
        ...
        try {
            stmt = con.prepareStatement("UPDATE tb_TipoLivros SET tipo = ? WHERE id = ?");
            stmt.setString(1, t.getTipo());
      ...
      public void delete(TipoLivro t){
        ...
        try {
            stmt = con.prepareStatement("DELETE FROM tb_TipoLivros WHERE id = ?");
